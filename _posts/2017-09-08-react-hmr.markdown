...
<blockquote>
Webpack at it's core is just a module bundler. It essentially detects dependencies between the stuff that makes up your application (for like of a better word) like code files,  style files etc. that makes up your code and creates a bundle out of it.
</blockquote>
